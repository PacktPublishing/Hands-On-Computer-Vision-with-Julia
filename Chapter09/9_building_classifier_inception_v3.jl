...
mx.fit(nnet, mx.ADAM(), train_data_provider, eval_data = valid_data_provider, n_epoch = 10, eval_metric = mx.MultiMetric([mx.Accuracy(), mx.ACE()]));
mx.save_checkpoint(nnet, "weights/book-cover-classifier", mx.OptimizationState(1, 0, 0, 0))
